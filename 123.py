...
print("Gaji karyawan Rp 300.000/jam, jika lembur dibayar 1/2 kali lipat perjam lemburnya, jadi dibayar Rp 450.000/jam untuk jam lembur")
karyawan_list = [
...
def karyawan_menu():
    ...
    if karyawan:
        ...
        print("Nama karyawan tidak ditemukan. Silakan coba lagi.")
...
def main():
    while True:
        ...
        if pilihan_user == "1":
            ...
            pilihan = input("Silakan pilih opsi Anda (1/2): ")
